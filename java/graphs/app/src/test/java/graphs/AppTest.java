...
public class AppTest {
  ...
  @Test public void testDepthFirst() throws Exception {
    ...
    String results = "[Node{value=1, next=null}, Node{value=8, next=null}, Node{value=7, next=null}, Node{value=6, next=null}, Node{value=5, next=null}, Node{value=4, next=null}, Node{value=3, next=null}, Node{value=2, next=null}]";
    assertEquals(results , newGraph.depthFirstTraversal(1).toString());
  }
